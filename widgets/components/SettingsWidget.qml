...
Item {
    ...
    Column {
        ...
        Row {
            ...
            Repeater {
                model: ["Общие", "Таймеры", "Плеер", "Погода", "CAVA"]

                delegate: Rectangle {
                    width: (otherTabs.width - 20) / 5
        ...
        Flickable {
            ...
            Column {
                ...
                Text {
                    visible: root.currentOtherTab === 0
                    text: "Основные шрифты, анимации и частота обновления данных"
                    color: Config.textMuted
                    font.family: Config.font
                    font.pixelSize: 10
                ...
                Row {
                    ...
                    height: 34
                    spacing: 8
                    Text { width: 210; text: "Основной шрифт интерфейса"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField {
                        id: generalFontField
                        width: 160; height: 30
                        text: Config.font
                ...
                Row {
                    ...
                    height: 34
                    spacing: 8
                    Text { width: 210; text: "LED-шрифт"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField {
                        id: ledFontField
                        width: 160; height: 30
                        text: Config.ledFont
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        contentItem: Text { text: parent.text; color: Config.text; font.family: Config.font; font.pixelSize: 11; leftPadding: parent.indicator.width + 5; verticalAlignment: Text.AlignVCenter }
                    }
                    Text { text: Config.animationsEnabled ? "включены" : "выключены"; color: Config.textMuted; font.family: Config.font; font.pixelSize: 10; verticalAlignment: Text.AlignVCenter }
                }
                ...
                Row {
                    ...
                    height: 30
                    spacing: 8
                    Text { width: 210; text: "Скорость анимаций (×)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField {
                        ...
                        font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true
                ...
                Text { visible: root.currentOtherTab === 0; text: "Обновление данных (мс / мин)"; color: Config.accent; font.family: Config.font; font.pixelSize: 12 }

                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "System Monitor, CPU (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: systemIntervalField; width: 100; height: 28; text: String(Config.systemMonitorInterval); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "CPU (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: cpuIntervalField; width: 100; height: 28; text: String(Config.cpuUpdateInterval); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Плеер (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: playerIntervalField; width: 100; height: 28; text: String(Config.playerUpdateInterval); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Погода сейчас (мин)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: weatherNowIntervalField; width: 100; height: 28; text: String(Config.weatherNowIntervalMinutes); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Погода по часам (мин)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: weatherHourlyIntervalField; width: 100; height: 28; text: String(Config.weatherHourlyIntervalMinutes); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Погода по дням (мин)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: weatherDailyIntervalField; width: 100; height: 28; text: String(Config.weatherDailyIntervalMinutes); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Минимальная высота громкости"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: volumeMinHeightField; width: 100; height: 28; text: String(Config.volumeMinHeight); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 0
                    Text { width: 210; text: "Максимальная высота громкости"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: volumeMaxHeightField; width: 100; height: 28; text: String(Config.volumeMaxHeight); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Размер текста Silence"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: silenceSizeField; width: 100; height: 28; text: String(Config.playerSilenceFontSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Размер длинного Silence"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: silenceLongSizeField; width: 100; height: 28; text: String(Config.playerSilenceLongFontSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Размер основной строки метаданных"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: metaSizeField; width: 100; height: 28; text: String(Config.playerMetaFontSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Размер остальных строк"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: metaSecondarySizeField; width: 100; height: 28; text: String(Config.playerMetaSecondaryFontSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Расстояние между строками"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: metaSpacingField; width: 100; height: 28; text: String(Config.playerMetaLineSpacing); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    CheckBox { id: boldArtistBox; width: 210; height: 30; text: "Жирный исполнитель"; checked: Config.playerBoldArtist; onToggled: { Config.playerBoldArtist=checked; settings.save() } contentItem: Text { text: parent.text; color: Config.text; font.family: Config.font; font.pixelSize: 11; leftPadding: parent.indicator.width+5; verticalAlignment: Text.AlignVCenter } }
                }
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    CheckBox { id: showProgressBox; width: 210; height: 30; text: "Показывать прогресс"; checked: Config.playerShowProgress; onToggled: { Config.playerShowProgress=checked; settings.save() } contentItem: Text { text: parent.text; color: Config.text; font.family: Config.font; font.pixelSize: 11; leftPadding: parent.indicator.width+5; verticalAlignment: Text.AlignVCenter } }
                }
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 2
                    Text { width: 210; text: "Размер иконок управления"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter }
                    TextField { id: controlIconSizeField; width: 100; height: 28; text: String(Config.playerControlIconSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Минимальная высота блока таймеров"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerMinHeightField; width: 100; height: 28; text: String(Config.timerMinHeight); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Шаг колеса таймера"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerWheelStepField; width: 100; height: 28; text: String(Config.timerWheelStep); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Ширина комментария"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerCommentWidthField; width: 100; height: 28; text: String(Config.timerCommentWidth); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Максимальная длина комментария"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerCommentMaxLengthField; width: 100; height: 28; text: String(Config.timerCommentMaxLength); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Отступ комментария до отсчёта"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerCommentGapField; width: 100; height: 28; text: String(Config.timerCommentGap); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Верхний отступ таймеров"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerRowTopField; width: 100; height: 28; text: String(Config.timerRowTopMargin); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Правый отступ таймеров"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerRowRightField; width: 100; height: 28; text: String(Config.timerRowRightMargin); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Анимация появления кнопок (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerFadeField; width: 100; height: 28; text: String(Config.timerButtonFadeDuration); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Сдвиг кнопок (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerSlideField; width: 100; height: 28; text: String(Config.timerButtonSlideDuration); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 1
                    Text { width: 210; text: "Исчезновение иконки (мс)"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: timerIconFadeField; width: 100; height: 28; text: String(Config.timerButtonIconFadeDuration); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Размер иконки текущей погоды"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherIconSizeField; width: 100; height: 28; text: String(Config.weatherIconSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Размер стрелки ветра"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherArrowSizeField; width: 100; height: 28; text: String(Config.weatherArrowSize); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Смещение стрелки ветра по Y"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Зазор стрелки до скорости"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherWindGapField; width: 100; height: 28; text: String(Config.weatherWindArrowGap); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Количество часов"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherHourlyCountField; width: 100; height: 28; text: String(Config.weatherHourlyCount); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Количество дней"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherDailyCountField; width: 100; height: 28; text: String(Config.weatherDailyCount); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
                ...
                Row { width: parent.width; height: 30; spacing: 8
                    visible: root.currentOtherTab === 3
                    Text { width: 210; text: "Верхний отступ погодных списков"; color: Config.text; font.family: Config.font; font.pixelSize: 11; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight }
                    TextField { id: weatherPaddingField; width: 100; height: 28; text: String(Config.weatherListTopPadding); color: Config.text; font.family: Config.font; font.pixelSize: 11; horizontalAlignment: Text.AlignHCenter; activeFocusOnTab: true; background: Rectangle { color: Config.background; border.color: Config.baseColor; border.width: 1; radius: 4 }
