...
ShellRoot {
    ...
    WidgetWindow { visible: Settings.player; offsetX: Settings.geometry.player[0]; offsetY: Settings.geometry.player[1]; contentWidth: Settings.geometry.player[2]; contentHeight: Settings.geometry.player[3]; Player { anchors.fill: parent; anchors.margins: 0 } }
